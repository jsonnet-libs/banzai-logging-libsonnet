{
  ...
  '#new':: d.fn(help='new returns an instance of Output', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    awsElasticsearch: {
      ...
      '#withInclude_timestamp':: d.fn(help='', args=[d.arg(name='include_timestamp', type=d.T.string)]),
